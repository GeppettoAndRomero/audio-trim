...
const CACHE_NAME = 'audio-trim-v1';
const RUNTIME_CACHE = 'audio-trim-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/audio-trim/',
  '/audio-trim/manifest.json',
  '/audio-trim/icon-192.png',
  '/audio-trim/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/audio-trim/manifest.json';
}
