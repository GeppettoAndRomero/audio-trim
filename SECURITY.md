...
`audio-trim` runs entirely in your browser. There is no server component and no
account system, so your audio is never uploaded. Most classic web vulnerabilities
...
- Anything that could send audio data or metadata off the device.
